...
async function init() {
    ...
    if (validProfiles.length > 0 && saveManagerModal && splashScreen) {
        ...
        const updateHeader = () => {
            const h2 = saveManagerModal.querySelector('#save-action-title');
            if (h2) {
                if (profileAction === 'rename') {
                    h2.innerHTML = "<span style='color: #3498db;'>Select Profile to Rename</span>";
                    h2.style.display = 'block';
                } else if (profileAction === 'delete') {
                    h2.innerHTML = "<span style='color: #f44336;'>Select Profile to Delete</span>";
                    h2.style.display = 'block';
                } else {
                    h2.innerHTML = "";
