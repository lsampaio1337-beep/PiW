...
export function showMap() {
    ...
    for (const [locationId, locationData] of Object.entries(state.config.mapCoordinates)) {
        ...
        let isUnlocked = state.stats.completedChallengeIds.includes(locationName) || state.stats.activeChallenges.includes(locationName) || locationName === 'Professor Oak Lab';
